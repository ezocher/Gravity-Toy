...
* Made three fixes that seem to have addressed these issues:
  * The entire simulation was running on the UI thread, fixed it to run the calculations on a worker thread which marshalls the UI updates onto the UI thread
