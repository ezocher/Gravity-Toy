...
public class FloatingPointUtil
{
    ...
    public const int MinimumDigitsPrecision = 4;
    ...
    // Specific example:
    //  The 4 digit limit allows any quantity at or above 1/100 of a millimeter to be added to 42,000 km (geosync orbit radius)
    //
